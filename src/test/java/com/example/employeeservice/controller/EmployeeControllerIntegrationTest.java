...
class EmployeeControllerIntegrationTest {
    ...
    public void givenEmployees_whenGetEmployees_thenReturnJsonEmployees() throws Exception{
        mockMvc.perform(get("/employees"))
                ...
                .andExpect(jsonPath("$[0].startContract", is("1998-12-31T05:37:10.000+00:00")))
                .andExpect(jsonPath("$[0].endContract", is(IsNull.nullValue())))
                .andExpect(jsonPath("$[0].active", is(true)))
                .andExpect(jsonPath("$[0].workingHours[0].startTimestamp", is("1998-12-31T05:37:50.000+00:00")))
                .andExpect(jsonPath("$[0].workingHours[0].stopTimestamp", is("1998-12-31T16:37:50.000+00:00")))
                .andExpect(jsonPath("$[0].workingHours[1].startTimestamp", is("1999-01-01T05:37:50.000+00:00")))
                .andExpect(jsonPath("$[0].workingHours[1].stopTimestamp", is("1999-01-01T16:37:50.000+00:00")))
                ...
                .andExpect(jsonPath("$[1].startContract", is("1998-12-31T05:37:10.000+00:00")))
                .andExpect(jsonPath("$[1].endContract", is(IsNull.nullValue())))
                .andExpect(jsonPath("$[1].active", is(true)))
                .andExpect(jsonPath("$[1].workingHours[0].startTimestamp", is("1998-12-31T05:37:50.000+00:00")))
                .andExpect(jsonPath("$[1].workingHours[0].stopTimestamp", is("1998-12-31T16:37:50.000+00:00")))
                .andExpect(jsonPath("$[1].workingHours[1].startTimestamp", is("1999-01-01T05:37:50.000+00:00")))
                .andExpect(jsonPath("$[1].workingHours[1].stopTimestamp", is("1999-01-01T16:37:50.000+00:00")))
                ...
                .andExpect(jsonPath("$[2].startContract", is("1998-12-31T05:37:10.000+00:00")))
                .andExpect(jsonPath("$[2].endContract", is(IsNull.nullValue())))
                .andExpect(jsonPath("$[2].active", is(false)))
                .andExpect(jsonPath("$[2].workingHours[0].startTimestamp", is("1998-12-31T05:37:50.000+00:00")))
                .andExpect(jsonPath("$[2].workingHours[0].stopTimestamp", is("1998-12-31T16:37:50.000+00:00")))
                .andExpect(jsonPath("$[2].workingHours[1].startTimestamp", is("1999-01-01T05:37:50.000+00:00")))
                .andExpect(jsonPath("$[2].workingHours[1].stopTimestamp", is("1999-01-01T16:37:50.000+00:00")))
